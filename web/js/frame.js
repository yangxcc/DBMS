...
(function () {
    ...
    var data = [
        ...
        },
        {
            ...
            path:'',
            children:[
                {id:'003',level:2, icon:'',title:'查询用户',path:'main.jsp',children:[]},
                {id:'005',level:2, icon:'',title:'添加用户',path:'page2.html',children:[]},
                {id:'006',level:2, icon:'',title:'删除用户',path:'page3.html',children:[]},
                {id:'007',level:2, icon:'',title:'用户信息修改',path:'page1.jsp',children:[]},
            ]
        },
        {
            id:'008',
            ...
            level:1,
            children:[
                {id:'009',level:2,icon:'',title:'客户查询',path:'page1.html',children:[]},
                {id:'010',level:2,icon:'',title:'添加客户',path:'page1.html',children:[]},
                {id:'011',level:2,icon:'',title:'删除客户',path:'page1.html',children:[]},
                {id:'012',level:2,icon:'',title:'客户信息修改',path:'page1.html',children:[]}
            ]
        },
        {
            id:'013',
            ...
            level:1,
            children:[
                {id:'014',level:2,icon:'',title:'查询业务联系人',path:'page1.html',children:[]},
                {id:'015',level:2,icon:'',title:'添加业务联系人',path:'page1.html',children:[]},
                {id:'016',level:2,icon:'',title:'删除业务联系人',path:'page1.html',children:[]},
                {id:'017',level:2,icon:'',title:'业务联系人信息修改',path:'page1.html',children:[]}
            ]
        },
        {
            id:'018',
            ...
            level:1,
            children:[
                {id:'019',level:2,icon:'',title:'货物信息查询',path:'page1.html',children:[]},
                {id:'020',level:2,icon:'',title:'添加货物信息',path:'page1.html',children:[]},
                {id:'021',level:2,icon:'',title:'删除货物信息',path:'page1.html',children:[]},
                {id:'022',level:2,icon:'',title:'货物信息修改',path:'page1.html',children:[]}
            ]
        },
        {
            id:'023',
            ...
            level:1,
            children:[
                {id:'024',level:2,icon:'',title:'订单信息查询',path:'page1.html',children:[]},
                {id:'025',level:2,icon:'',title:'订单信息修改',path:'page1.html',children:[]}
            ]
        }
    ];
